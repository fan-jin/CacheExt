...
public class RConfig {
	...
	public static double SPEED = doubleProperty("rgame.player_speed");
	
	public static double MAP_BOUND_X = doubleProperty("rgame.map_bounds.x");
	public static double MAP_BOUND_Y = doubleProperty("rgame.map_bounds.y");
	/*
	 *  (-100,100)-----------(100,100)
	 *  |                            |
	 *  |                            |
	...
	public static double TILE_SIZE_X = doubleProperty("rgame.tile_size.x");
	public static double TILE_SIZE_Y = doubleProperty("rgame.tile_size.y");
	...
	public static boolean ENABLE_FAKE_FLOCKING = boolProperty("rgame.enable_fake_flocking");
	...
	public static int SUBSCRIPTION_RANGE = intProperty("rgame.subscription_range");
	...
	private static int intProperty(String name) {
		return Integer.parseInt(getProperties().getProperty(name, "0"));
	}
	
	private static boolean boolProperty(String name) {
		return Boolean.parseBoolean(getProperties().getProperty(name, "False"));
	}
	
	private static double doubleProperty(String name) {
		return Double.parseDouble(getProperties().getProperty(name, "0.0"));
	}
}
