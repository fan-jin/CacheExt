package Mammoth.NetworkEngine.RPub.Game;
...
import Mammoth.NetworkEngine.RPub.ControlMessages.Debug.PlanAppliedControlMessage;
import Mammoth.NetworkEngine.RPub.ControlMessages.Debug.RPlayerCrashedControlMessage;
import Mammoth.NetworkEngine.RPub.ControlMessages.Debug.SubscribedToChannelControlMessage;
import Mammoth.NetworkEngine.RPub.Game.Messages.RGameAcquirePlayerMessage;
import Mammoth.NetworkEngine.RPub.Game.Messages.RGameActivateMessage;
import Mammoth.NetworkEngine.RPub.Game.Messages.RGameUpdateFlockInfoMessage;
...
public class RServer {
	...
	public void launch() {
		...
		try {
			...
			outputFileWriter.write("AvgResponseTime" + ";" + "RebalancingTriggered*1000" + ";" + "HostCount*125" + "\n");
		} catch (IOException e) {
	...
	private void processCommand(String line) {
		if (line.equals("exit")) {
			...
			try {
				...
				// Send msg
				engine.send("rgame-broadcast", new RGameActivateMessage(playerStart, playerEnd, active, flocking));
